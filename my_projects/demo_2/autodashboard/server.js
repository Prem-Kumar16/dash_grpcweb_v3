...
//const {Empty, CANSignal} = require('./datasim_pb.js');
//const {CANSignalServiceClient} = require('./datasim_grpc_pb.js');
...
var service_client = new ServiceRegistryClient('localhost:50000', grpc.credentials.createInsecure());
